  ...
  return (
    ...
    <div style={{ maxWidth: "900px" }}>
            ...
            <ol>
              ...
              <li><a className='default-li' style={{ padding: "0px" }} href='https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-desktop-6.0.24-windows-x64-installer' target="_blank">.NET 6.0 Desktop Runtime x64</a></li>
