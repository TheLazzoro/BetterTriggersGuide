...
A custom trigger editor for <a style={{ color: "#f90" }}>**Warcraft III: Reforged**</a>
<br/>
...
- <a style={{ color: "#5c5" }}>Keybinding menu.</a>
- <a>Action- and condition definitions: Define your own re-usable actions and conditions.</a>
- <a style={{ color: "#5c5" }}>More natives in GUI.</a>
- <a style={{ color: "#5c5" }}>Local variables.</a>
- <a style={{ color: "#5c5" }}>Editor color themes.</a>
- <a>and more...</a>
