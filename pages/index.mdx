...
## Planned features
- ✔️ <a style={{ color: "#5c5" }}>Keybinding menu.</a>
- ✔️ <a style={{ color: "#5c5" }}>More natives in GUI.</a>
- ✔️ <a style={{ color: "#5c5" }}>Local variables.</a>
- ✔️ <a style={{ color: "#5c5" }}>Editor color themes.</a>
- <a>Trigger template/library importer.</a>
- <a>Action- and condition definitions: Define your own re-usable actions and conditions.</a>
- <a>and more...</a>
